...
<head>
    ...
    <title>Watchlist | Bag It Up</title>
                    ...
                    <div class="row">
                        <div class="col-12 mb-2">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <label class="form-label fs-1 text-danger">Watchlist &hearts;</label>
                                </div>


                                <div class="col-12 col-lg-2 bbb" >
                                    ...
                                    <nav class="nav nav-pills flex-column">
                                        <a class="nav-link" aria-current="page" href="#">My Watchlist</a>
                                                    ...
                                                    <div class="row g-0">
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="card-body">
                                                                ...
                                                                ?>
                                                                <h5 class="card-title fs-4 fw-bold text-success"><?php echo $product_data["title"]; ?></h5>
                                                                <?php
                                                                ...
                                                                <span class="fs-5 text-info"><?php echo $product_data["qty"]; ?> Items available</span>
                                                                <br />
                                                                <span class="fs-5 fw-bold text-black-50">Seller :</span>
                                                                <span class="fs-6 text-black">Methma</span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
