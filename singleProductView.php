...
?>
        ...
        <head>
            ...
            <title><?php echo $product_data["title"]; ?> | Bag it Up</title>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="row border-bottom border-dark">
                                                    ...
                                                    <h5 class="card-title fs-4 fw-bold"><?php echo $product_data["title"]; ?></h5>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row border-bottom border-dark">
                                                    <div class="col-12 my-2">
                                                        <span class="badge">
                                                            ...
                                                            <label class="text-dark fs-5 fw-normal">4.5 Stars | 39 Reviews & Ratings</label>
                                                        </span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row border-bottom border-dark">
                                                    <div class="col-12 my-2">
                                                        ...
                                                        <span class="fs-5 text-primary"><b>Return Policy : </b>1 Week Return Policy</span><br />
                                                    ...
                                                    <div class="col-12">
                                                        <div class="row">
                                                            <div class="my-2 offset-lg-2 col-12 col-lg-8 border border-1 border-danger rounded">
                                                                <div class="row">
                                                                    <div class="col-3 col-lg-2 border-end border-2 border-danger tag">
                                ...
                                <div class="row g-2">
                                    <div class="offset-1 offset-lg-0 col-4 col-lg-2">
                                        <div class="card" style="width: 12rem;">
                                            <img src="resource/bag_images/b2.jpeg" class="card-img-top" />
                                            <div class="card-body">
                                                <h5 class="card-title">Bag Pack</h5>
                                                <p class="card-text">Dimensions 15cm x 32cm x 46cm</p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-9">
                                                <label class="form-label fs-4">Laptop Bag</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-9">
                                                <label class="form-label fs-4"><?php echo $product_data["title"]; ?></label>
                                            </div>
                                        </div>
                                    </div>
