...
<head>
    ...
    <title>Purchasing History | Bag it Up</title>
                            ...
                            ?>
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-1 text-center bg-secondary text-lg-start">
                                            <label class="form-label text-dark fw-bold fs-3 py-3"><?php echo $invoice_data["id"]; ?></label>
                                        </div>
                                        ...
                                        <div class="col-12 col-lg-2 text-center text-lg-end">
                                            <label class="form-label fs-5 py-5 text-dark">Rs. <?php echo $invoice_data["total"]; ?> .00</label>
                                        </div>
                                        <div class="col-12 col-lg-2 text-center text-lg-end">
