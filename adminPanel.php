...
?>
    ...
    <head>
        ...
        <title>Admin Panel | Bag it Up</title>
                        ...
                        <div class="col-12">
                            <div class="row g-1">
                                ...
                                <div class="col-6 col-lg-16">
                                    <div class="row g-1">
                                        <div class="col-12 bord text-dark text-center rounded" style="height: 100px;">
                                            <br />
                                ...
                                <div class="col-6 col-lg-6 px-1">
                                    <div class="row g-1">
                                        <div class="col-12 bord text-black text-center rounded" style="height: 100px;">
                                            <br />
                                ...
                                <div class="col-6 col-lg-6 px-1">
                                    <div class="row g-1">
                                        <div class="col-12 text-dark bord text-center rounded" style="height: 100px;">
                                            <br />
                        ...
                        <div class="col-12 bg-light">
                            <div class="row">
                                <div class="col-12 col-lg-2 text-center my-3">
                                    <label class="form-label fs-4 fw-bold text-dark">Total Active Time</label>
                                </div>
                                <div class="col-12 col-lg-10 text-center my-3">
                                    ...
                                    ?>
                                    <label class="form-label fs-4 fw-bold text-info">
                                        <?php
