...
<head>
    ...
    <title>Update Product | Bag it Up</title>
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-12">
                                                <label class="form-label text-secondary fw-bold fs-5" style="font-size: 20px;">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-lg-4">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <label class="form-label text-secondary fw-bold fs-5">Add Product Quantity</label>
                                                    </div>
                                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-12">
                                                <label class="form-label text-secondary fw-bold fs-5">Delivery Cost</label>
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-12">
                                                <label class="form-label text-secondary fw-bold fs-5">Product Description</label>
                                            </div>
                                            <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-12">
                                                <label class="form-label text-secondary fw-bold fs-5">Add Product Images</label>
                                            </div>
