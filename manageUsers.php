...
<head>
    ...
    <title>Manage Users | Admins | Bag it Up</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 bg-light text-center">
                <label class="form-label text-danger fw-bold fs-1">Manage All Users</label>
            </div>
            ...
            ?>
                <div class="col-12 mt-3 mb-3">
                    <div class="row">
                        <div class="col-2 col-lg-1 bord py-2 text-end">
                        ...
                        <div class="col-2 d-none d-lg-block bg-light py-2" onclick="viewMsgModal('<?php echo $selected_data['email']; ?>');">
                            <img src="resource/profile_img/Methma_637aa86c49a33.jpeg" style="height: 40px;margin-left: 80px;" />
                        </div>
                        <div class="col-4 col-lg-2 bord py-2">
                        ...
                        <div class="col-4 col-lg-2 d-lg-block bg-light py-2">
                            <span class="fs-4 ">methma@gmail.com</span>
                        </div>
                        <div class="col-2 d-none d-lg-block bord py-2">
                            <span class="fs-4 text-dark">0756722784</span>
                        </div>
                        <div class="col-2 d-none d-lg-block bg-light py-2">
                            <span class="fs-4 ">2023-1-05</span>
                        </div>
