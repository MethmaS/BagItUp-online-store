            ...
            <div class="col-12 py-5 px-4">
                <div class="row overflow-hidden shadow rounded">
                    <div class="col-12 col-lg-5 px-0">
                        <div class="bg-white">
                            <div class="msgbox px-4 py-2">
                                <div class="col-12">
                                    <h5 class="mb-0 my-1 fw-bold text-warning">Recents</h5>
                                </div>
                                <div class="col-12">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                            <div class="message_box" id="message _box">
                                                <?php

                                                $msg_num = $msg_rs->num_rows;
                                                for ($x = 0; $x, $x < $msg_num; $x++) {
                                                ...
                                                ?>
                                                        <div class="list-group rounded-0" onclick="viewMessage('<?php echo $msg_data['from']; ?>');">
                                                            <a href="#" class="list-group-item list-group-item-action text-dark  rounded-0 bg-light">
                                                                <div class="media">
                                                                    <?php
                                            ...
                                            ?>
                                                <div class="mt-1 sent">
                                                    <div class="list-group rounded-0" onclick="viewMessages('<?php echo $msg_data['from']; ?>');">
                                                        <a href="#" class="list-group-item list-group-item-action text-black rounded-0 bg-light">
                                                            <div class="media">
                                                                <?php
                        ...
                        <div class="col-12 px-2">
                            <div class="row">
                                <div class="input-group  mb-3">
                                    <input type="text" id="msg_txt" class="form-control rounded border-secondary py-3 bg-light msg" placeholder="Type a message ..." aria-describedby="send_btn">
                                    <button class="btn btn-light border-secondary fs-2" id="send_btn" onclick="send_msg();"><i class="bi bi-send-fill fs-1"></i></button>
                                </div>
                            </div>
                        </div>
                        <!-- text -->
