...
<head>
    ...
    <title>Manage Products | Admins | Bag it Up</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 bg-light text-center">
                <label class="form-label text-danger fw-bold fs-1">Manage All Products</label>
            </div>
                ...
                <div class="col-12 mt-3 mb-3">
                    <div class="row">
                        <div class="col-2 col-lg-1 bord py-2 text-end">
                            <span class="fs-4 fw-bold text-dark"><?php echo $selected_data["id"]; ?></span>
                        </div>
                        <div class="col-2 d-none d-lg-block bg-light py-2" onclick="viewProductModal('<?php echo $selected_data['id']; ?>');">
                            ...
                            if ($image_num == 0) {
                            ?>
                                <img src="" style="height: 40px;margin-left: 80px;" />
                            <?php
                            } else {
