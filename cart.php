    ...
    <div class="container-fluid">
        <div class="row">
            ...
            ?>
                ...
                <div class="col-12 border border-1 border-none rounded mb-3">
                    <div class="row">

                        <div class="col-12">
                            <label class="form-label fs-1 text-warning">Cart <i class="bi bi-cart4 fs-1 text-success"></i></label>
                        </div>
                                        ...
                                        <div class="card mb-3 mx-0 col-12">
                                            <div class="row g-0">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" title="<?php echo $product_data["title"]; ?>" data-bs-content="<?php echo $product_data["description"]; ?>" title="Product Description">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="card-body">
                                                        ...
                                                        &nbsp; <span class="fw-bold text-black-50">Condition : New</span>
                                                        <br>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="card-body d-grid">
                                                        <a href='<?php echo "singleProductView.php?id=" . $product_data["id"]; ?>' class="col-12  btn btn-outline-success mb-2">Buy Now</a>
                        ...
                        <div class="col-12 col-lg-3">
                            <div class="row">
                                ...
                                <div class="col-12 mt-3 mb-3 d-grid">
                                    <button class="btn btn-primary fs-5 fw-bold" type="submit" id="payhere-payment" onclick="payNow(<?php echo $pid ?>);">CHECKOUT</button>
                                </div>
