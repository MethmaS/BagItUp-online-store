...
<head>
    ...
    <title>User Profile | Bag it Up</title>
    ...
    <div class="container-fluid">
        <div class="row">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-3 border-end">
                                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                        ...
                                        <label for="profileimg" class="profileImgbtn mt-5" onclick="changeImage();">Update Profile Image</label>
                                    ...
                                    <div class="p-3 py-5">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-12 d-grid mt-3">
                                                <button class="updateProfilebtn" onclick="updateProfile();">Update My Profile</button>
                                            </div>
            ...
            <?php
                ...
                header("Location:http://localhost/eshopf/home.php");
            }
