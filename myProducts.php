...
?>
    ...
    <head>
        ...
        <title>My Products | Bag It Up</title>
        ...
        <div class="container-fluid">
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-8">
                                    <div class="row text-center text-lg-start">
                                        ...
                                        <div class="col-12">
                                            <span class="text-50 fw-bold text-secondary"><?php echo $email; ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-lg-8">
                            <div class="row">
                                <div class="col-12 col-lg-10 mt-2 my-lg-4">
                                    <h1 class="offset-2 offset-lg-2 text-dark fw-bold title1 mb-0 mt-0">My Products</h1>
                                </div>
                                <div class="col-10 col-lg-2 offset-1 mb-2 mt-2 my-lg-4 mx-lg-0 d-grid">
                                    <button class="addproductbtn" onclick="window.location='addProduct.php'">Add Product</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <div class="row">
                        <!-- filter -->
                        <div class="col-12 col-lg-2 exs">
                            <div class="row">
                                <div class="col-12 mt-3 fs-5">
                                    <div class="row">
                                        <div class="col-12">
                                            <label class="form-label fw-bold fs-3 text-success">Sort Products</label>
                                        </div>
                                        <div class="col-11">
                                            <div class="row">
                                                <div class="col-10">
                                        ...
                                        <div class="col-12">
                                            <label class="form-label fw-bold text-secondary">Active Time</label>
                                        </div>
                                        <div class="col-12">
                                            <hr style="width: 80%;" />
                                        </div>
                                        ...
                                        <div class="col-12 mt-3">
                                            <label class="form-label fw-bold text-secondary">By quantity</label>
                                        </div>
                                        <div class="col-12">
                                            <hr style="width: 80%;" />
                                        </div>
                                        ...
                                        <div class="col-12 mt-3">
                                            <label class="form-label fw-bold text-secondary">By condition</label>
                                        </div>
                                        <div class="col-12">
                                            <hr style="width: 80%;" />
                                        </div>
                                        ...
                                        <div class="col-12 text-center mt-3 mb-3">
                                            <div class="row g-2">
                                                <div class="col-6 col-lg-6 d-grid">
                                                    <button class="btn btn-secondary fw-bold" onclick="sort1(0);">Sort</button>
                                                </div>
                                                <div class="col-6 col-lg-6 d-grid">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="row g-1">
                                                                        <div class="col-12 col-lg-6 d-grid">
                                                                            <a class="btn btn-outline-secondary fw-bold" onclick="sendId(<?php echo $selected_data['id']; ?>);">Update</a>
                                                                        </div>
                                                                        <div class="col-12 col-lg-6 d-grid">
