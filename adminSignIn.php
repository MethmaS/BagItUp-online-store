...
<head>
    ...
    <title>Admin SignIn | Bag it Up</title>
        ...
        <div class="row align-content-center">
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-12 mx-4 mx-lg-5">
                        <p class="text-center title1">Welcome to Bag it Up Admins</p>
                    </div>
                    ...
                    <div class="col-12 col-lg-6 d-block">
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-lg-5 d-grid">
                                <button class="signbtn" onclick="adminVerification();">Send Verification Code</button>
                            </div>
                            <div class="col-12 col-lg-5 d-grid">
            ...
            <div class="col-12 fixed-bottom text-center">
                <p>&copy; 2023 bagitup.lk | All Rights Reserved</p>
            </div>
