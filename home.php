        ...
        <div class="row">
            ...
            <div class="col-12 justify-content-center">
                <div class="row mb-3">
                    ...
                    <div class="offset-4 offset-lg-1 col-4 col-lg-1 logo" style="height: 80px;"></div>
                    ...
                    <div class="col-12 col-lg-2 d-grid">
                        <button class="searchbtn rounded-2 mt-3 mb-4" onclick="basicSearch(0);">Search</button>
                    </div>
            ...
            <div class="col-12" id="basicSearchResult">
                <div class="row">
                    ...
                    <!-- <div class="col-12 m-0">
                        <div class="row">
                            <div class="col-5 d-none d-lg-block bg-light mb-3">
                                <div class="row">
                                    <div id="carouselExampleSlidesOnly" class="col-lg-12 carousel slide" data-bs-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <h5 class="title2 text-center">Welcome to Bag It Up</h5></br></br>
                                                <h5 class="title2 text-center">For your everyday look</h5>
                                            </div>
                                            <div class="carousel-item">
                                                <h5 class="title2 text-center">Welcome to Bag It Up</h5>
                                            </div>
                                            <div class="carousel-item">
                                                <h5 class="title2 text-center">Welcome to Bag It Up</h5>
                                            </div>
                            ...
                            <div class="col-12  d-none d-lg-block mb-3 bg-light">
                                <div class="row">

                                    <div id="carouselExampleIndicators" class="col-lg-12 carousel slide carousel-fade" data-bs-ride="true">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img src="resource/slider_img2/h2.webp" class="d-block poster-img-2" />
                                                <div class="carousel-caption d-none d-md-block poster-caption">
                                                    <h5 class="poster-title text-start">For your everyday look</h5>
                                                    <p class="poster-txt1">Welcome to Bag it Up</p>
                                                </div>
                                            </div>
                                            <div class="carousel-item">
                                                <img src="resource/slider_img2/h3.jpg" class="d-block poster-img-2" />
                                                <div class="carousel-caption d-none d-md-block poster-caption-1">
                                                    <h5 class="poster-title2">The ideal bag for any location you visit</h5>
                                                    
                                                </div>
                                            </div>
                                            <div class="carousel-item">
                                                <img src="resource/slider_img2/h1.png" class="d-block poster-img-2" />
                                                <div class="carousel-caption d-none d-md-block poster-caption-1">
                                                    <h5 class="poster-title3">A high quality web based store specializing in bags located in Sri Lanka</h5>
                                    ...
                                    `status_id`='1' ORDER BY `datetime_added` DESC LIMIT 4 OFFSET 0");
                                        ...
                                        ?>
                                            ...
                                            <div class="card col-12 col-lg-2 mt-2 mb-2" style="width: 18rem;">
                                                ...
                                                ?>
                                                <a class="inner"><img src="<?php echo $image_data["code"]; ?>" class="card-img-top img-thumbnail mt-2" style="height: 180px;" /></a>

                                                <div class="card-body ms-0 m-0 text-center">
                                                    <h5 class="card-title fs-6 fw-bold"><?php echo $product_data["title"]; ?></h5>
                                                    <!-- <span class="badge bg-info"><?php echo $product_data["description"]; ?></span><br/> -->
                                                    ...
                                                    ?>
                                                        ...
                                                        <button class="col-12 cartH mb-2" onclick="addToCart(<?php echo $product_data['id']; ?>);">Add to Cart</button>
                                                    ...
                                                    if ($watchlist_num == 1) {
                                                    ?>
                                                        <button class="col-12 btn btn-outline-light mt-2 border border-light" onclick='addToWatchlist(<?php echo $product_data["id"]; ?>);'>
